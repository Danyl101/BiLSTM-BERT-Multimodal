...
try:
    ...
    train_load=pd.read_csv(config['paths']['lstm']['nifty_train_scaled_data'])
    train_data=train_load[['Open','High','Low','Close','Volume']]

    val_load=pd.read_csv(config['paths']['lstm']['nifty_validation_scaled_data'])
    val_data=val_load[['Open','High','Low','Close','Volume']]

    test_load=pd.read_csv(config['paths']['lstm']['nifty_test_scaled_data'])
